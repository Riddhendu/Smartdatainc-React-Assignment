...
import DirectionsRunItem from '@material-ui/icons/DirectionsRun';
...
function App() {
  ...
  return (
    <div className="App">
     <h2>Recipe app</h2>
     <form className={gridClasses.root} noValidate autoComplete="off">
      <TextField id="outlined-basic"  variant="outlined"  tyepe="text" value={search} onChange={(e)=>setSearch(e.target.value)}/>
